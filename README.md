...
We use a list of Event Evoking Frame curated manually to find out events from text, the list can be obtained [here](http://accra.sp.cs.cmu.edu/~zhengzhl/downloads/event_evoking_frames.txt). We also upload a copy here at the Github: https://github.com/hunterhector/EventSalience/blob/master/event_evoking_frames.txt
